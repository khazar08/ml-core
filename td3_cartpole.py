...
class TD3Agent:
    def __init__(self, state_dim, action_dim, lr_actor=0.001, lr_critic=0.001, gamma=0.99, tau=0.005, policy_noise=0.2, noise_clip=0.5, policy_freq=2):
        self.gamma = gamma
        self.tau = tau
    ...
    def learn(self):
        ...
        return actor_loss.item() if actor_loss != 0 else 0, (critic1_loss.item() + critic2_loss.item()) / 2
...
def main():
    ...
    num_episodes = 500
    print(f"Training TD3 agent for {num_episodes} episodes...")
    ...
    print("\nModel saved as 'td3_cartpole.pth'")
